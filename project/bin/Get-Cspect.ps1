...
c:\windows\system32\curl -o $PSScriptRoot\CSpect2_12_9.zip http://www.javalemmings.com/public/zxnext/CSpect2_12_9.zip
Expand-Archive -force $PSScriptRoot\CSpect2_12_9.zip $PSScriptRoot
