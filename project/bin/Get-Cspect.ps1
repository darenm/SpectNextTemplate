...
c:\windows\system32\curl -o $PSScriptRoot\CSpect2_12_5.zip http://www.javalemmings.com/public/zxnext/CSpect2_12_5.zip
Expand-Archive -force $PSScriptRoot\CSpect2_12_5.zip $PSScriptRoot
